#!/bin/bash
#
# setalsa-fmt3000-tm733.sh
#
# Configuration for a Yaesu FMT-3000 on left channel and an
# Kenwood TM-733 attached to Right channel on a DRAWS HAT
#
# mDin6  on left channel,  direwolf chan 0, radio Yaesu FMT-3000
# mDin6  on right channel, direwolf chan 1, radio Kenwood TM-733
#
# For UDRC II, enable setting receive path from discriminator (DISC)

DEBUG=

RADIO="FMT-3000 and TM-733"
