...
# setalsa-ic208h.sh
#
# Configuration for an ICOM IC-208h on left channel on a DRAWS HAT
#
# mDin6 connector on left channel,  direwolf chan 0, radio ICOM IC-208h
# mDin6 connector on right channel, direwolf chan 1, radio ICOM IC-208h
#
